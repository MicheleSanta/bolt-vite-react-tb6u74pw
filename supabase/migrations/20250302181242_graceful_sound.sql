/*
  # Create affidamento_documenti table and storage policies

  1. New Tables
    - `affidamento_documenti` - Stores metadata for uploaded documents
      - `id` (serial, primary key)
      - `affidamento_id` (integer, references affidamento)
      - `nome_file` (text)
      - `tipo_file` (text)
      - `dimensione` (integer)
      - `url` (text)
  ...
  3. Security
    - Enable RLS on `affidamento_documenti` table
